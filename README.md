...
Digital Craftsman (Developer/Technologist/Innovator)
...
I'm building innovative web applications using technologies like React, Node.js, and Python. I specialize in creating dynamic web and mobile applications and solving complex problems with AI. I love turning ideas into real-world solutions that drive impact.
...
- **Master of Science in Computer Science**  
  Washington University in St. Louis (Expected Graduation: May 2026)  
...
- **Bachelor of Technology in Computer Science and Engineering**  
  SRM Institute of Science and Technology, Chennai, India (Aug 2020 - May 2024)  
...
- **Programming Languages**: C++, C, Python, SQL, PHP, JavaScript, TypeScript
- **Frameworks/Technologies**: React, Node.js, Express.js, Swift, Material UI, MongoDB, MySQL
- **Cloud/DevOps**: AWS (EC2, S3, IAM, Docker, Kubernetes)
...
- **[MLAgriCare](https://github.com/aman070902/MLAgriCare)** (Jul 2024)  
...
- **Full Stack Developer Intern** - Bharat Intern, Remote (Sep 2023 - Oct 2023)  
  - Developed a video conferencing website with real-time communication features.
  - Built a project management tool for advanced task management with JavaScript and local storage.

- **International Immersion Program** - UCSI University, Kuala Lumpur, Malaysia (Feb 2023 - Mar 2023)  
  - Developed a web application for visualizing company datasets using Python, HTML, CSS, JavaScript, and Power BI.
